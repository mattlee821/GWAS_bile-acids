...
PHENOFILE=/home/leem/001_projects/GWAS_bile-acids/data/data-for-GWAS/female_combined.txt
SCRATCH=/scratch/leem/GWAS/complex/female/combined/
VAR=Tamca_CLRT_24_log2_normalised
...
for FILE in `cat filelist`; do 
	...
	--covar ${PHENOFILE} \
    --covar-name Cncr_Caco_Clrt, Fasting_C, Age_Blood, batch, QgE130301, Diabet, Bmi_C, QE_FAT, QE_FIBT, PC1, PC2, PC3, PC4, PC5, PC6, PC7, PC8, PC9, PC10 \
