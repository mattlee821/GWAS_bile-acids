...
PHENOFILE=/home/leem/001_projects/GWAS_bile-acids/data/data-for-GWAS/combined_controls.txt
SCRATCH=/scratch/leem/GWAS/complex/combined/control/
...
for FILE in `cat filelist`; do 
	...
	--covar ${PHENOFILE} \
    --covar-name Sex, Fasting_C, Age_Blood, batch, QgE130301, Diabet, Bmi_C, QE_FAT, QE_FIBT, PC1, PC2, PC3, PC4, PC5, PC6, PC7, PC8, PC9, PC10 \
